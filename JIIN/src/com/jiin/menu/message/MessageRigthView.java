...
public class MessageRigthView extends FrameLayout{
	
	public MessageRigthView(Context context) {
		super(context);
		init();
	}
	...
	private void init() {
		LayoutInflater.from(getContext()).inflate(R.layout.item_message_right, this);
