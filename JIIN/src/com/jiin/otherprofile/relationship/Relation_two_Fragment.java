...
public class Relation_two_Fragment extends Fragment {
	
	ArrayList<User> relation = new ArrayList<User>();
	
	ImageView me, friend1, you;
	View bar;
	View meFrame, youFrame;
	
	@Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		final View view= inflater.inflate(R.layout.fragment_relation_2, container, false);
		...
		new Handler().postDelayed(new Runnable() {
			...
			public void run() {
				...
				ImageLoader.getInstance().displayImage(JiinConstant.SERVER_URL+relation.get(1).mainPicture, friend1);
				new Handler().postDelayed(new Runnable() {
